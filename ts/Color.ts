...
class Color
{
	...
	/**
	 * Constructor
	 * @param arg1 - The source of the color.
	 * Can be:
	 * - The red channel
	 * - A string representing the CSS string rgb(), rgba(), #FF00FF
	 * - An array of numbers with or without alpha such as [255,0,255,0.5]
	 * @param arg2 - The green channel of the color
	 * @param arg3 - The blue channel of the color
	 * @param arg4 - The alpha channel of the color
	 */
	constructor(arg1:number|string|Array<number>, arg2?:number, arg3?:number, arg4?:number)
	{
		let r:number | undefined;
		let g:number | undefined;
		let b:number | undefined;
		let a:number = arg4 ?? 1; //Quadruple or default
		
		// TRIPLE
		if (typeof arg3 === 'number' && typeof arg2 === 'number' && typeof arg1 === 'number') {
			// R G B		
			r = arg1;
			g = arg2;
			b = arg3;
		...
		function isColorValue(n:number)
		{
			return ((n >= 0) && (n < 256));
		}
		function isAlphaValue(a:number)
		{
			return ((a >= 0) && (a <= 1));
		}
	}
